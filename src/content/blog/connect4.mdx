...
<Connect4 ai="random" subtitle="you vs. random AI" />
...
<Connect4 ai="heuristic" subtitle="you vs. a heuristic AI" />
...
<Connect4 ai="minimax" depth={6} showEval subtitle="you vs. minimax (depth 6)" />
...
<Connect4 ai="alphabeta" depth={6} showControls subtitle="you vs. alpha-beta (adjustable depth)" />

Alright, you lost. Don't even cap.

Let's fast forward through a bunch of other stuff we're leaving out.

*[explanation of all techniques we've left out]*
...
<Connect4 ai="solver" aiFirst subtitle="the solver moves first — try to win" />
